...
SECRET_KEY = 'django-insecure-c#cuhk27%=#*0_)o2o9ag9u!(swkyo_-@pm=u1+f3l(ol=tgr('
...
# Modelo por defecto al crear usuario
...
LOGIN_REDIRECT_URL = 'home'  # Nombre de la URL donde quieres redirigir después de login

# Redirección después de cerrar sesión
LOGOUT_REDIRECT_URL = 'home'  # Nombre de la URL donde quieres redirigir después de logout
